			...
			public void actionPerformed(ActionEvent e) {
				...
				if(tfUsername.getText().equals("")
					...
					if(pass.equals(confimpass)) {
						if(employeeModel.accExists(tfUsername.getText())) {
							JOptionPane.showMessageDialog(null, "Tên tài khoản đã tồn tại",
				  	                  "Thêm tài khoản", JOptionPane.ERROR_MESSAGE);
						}
						else if(employeeModel.addAccountEmployee(comboBoxEmployee.getSelectedItem().toString(), tfUsername.getText(), pass))
