...
public class InforUserForm {
	...
	public InforUserForm() throws IOException {
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(tfIDEmployee.getText().equals("")
					...
					if(tfCVEployee.getText().toString().equals("Quản Lí"))
						employee.setType(0);
					else if(tfCVEployee.getText().toString().equals("Thu Ngân"))
						employee.setType(1);
					else if(tfCVEployee.getText().toString().equals("Thợ Máy"))
						employee.setType(2);
        ...
        if(employee.getType() == 0) {
        	tfCVEployee.setText("Quản Lí");
        }else if(employee.getType() == 1) {
        	tfCVEployee.setText("Thu Ngân");
        }else if(employee.getType() == 2) {
        	tfCVEployee.setText("Thợ Máy");
        }
