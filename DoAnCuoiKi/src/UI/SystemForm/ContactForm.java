...
public class ContactForm {
	...
	public ContactForm() {
	    ...
	    JLabel lbCourse = new JLabel("ĐỒ ÁN THIẾT KẾ PHẦN MỀM HƯỚNG ĐỐI TƯỢNG");
	    ...
	    JLabel lbStudent2 = new JLabel("Đặng Hữu Phúc    -    19110432 ");
	    ...
	    JLabel lbTeacher = new JLabel("Giảng viên hướng dẫn : Thầy Nguyễn Trường Hải");
